...
// Interface for form validation errors -> AI Added
...
interface ExpenseFormProps {
  onSubmit: (expenseData: { // Made into an onSubmit field
    description: string;
    amount: number;
    category: ExpenseCategory;
    date: string;
...
const ExpenseForm: React.FC<ExpenseFormProps> = ({ onSubmit }) => {
  ...
  // Local UI state (must be inside the component so hooks work correctly)
